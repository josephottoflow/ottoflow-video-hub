...
const ROUTES: Record<TaskType, { basic: RouteConfig; advanced: RouteConfig }> = {
  ...
  "script-generate": {
    basic:    { provider: "gemini", model: "gemini-2.5-flash", maxTokens: 512,  temperature: 0.7, cacheTtlSeconds: 86_400 },
    advanced: { provider: "gemini", model: "gemini-2.5-flash", maxTokens: 512,  temperature: 0.8, cacheTtlSeconds: 86_400 },
  },
  "hook-generate": {
    basic:    { provider: "gemini", model: "gemini-2.5-flash", maxTokens: 256,  temperature: 0.8, cacheTtlSeconds: 43_200 },
    advanced: { provider: "gemini", model: "gemini-2.5-flash", maxTokens: 256,  temperature: 0.9, cacheTtlSeconds: 43_200 },
  },
  "scene-plan": {
    basic:    { provider: "gemini", model: "gemini-2.5-flash", maxTokens: 1024, temperature: 0.5, cacheTtlSeconds: 86_400 },
    advanced: { provider: "gemini", model: "gemini-2.5-flash", maxTokens: 1024, temperature: 0.6, cacheTtlSeconds: 86_400 },
  },
  "caption-generate": {
