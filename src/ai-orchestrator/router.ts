...
const ROUTES: Record<TaskType, { basic: RouteConfig; advanced: RouteConfig }> = {
  "topic-generate": {
    ...
    advanced: { provider: "gemini", model: "gemini-2.0-flash", maxTokens: 2048, temperature: 0.9, cacheTtlSeconds: 0 },
  },
  "script-generate": {
  ...
  "hook-generate": {
    ...
    advanced: { provider: "gemini", model: "gemini-2.0-flash", maxTokens: 256,  temperature: 0.9, cacheTtlSeconds: 43_200 },
  },
  "scene-plan": {
