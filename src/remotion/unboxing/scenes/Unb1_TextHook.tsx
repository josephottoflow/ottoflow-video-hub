...
export const Unb1_TextHook: React.FC<{ text: string; colors: BrandColors; backgroundSrc?: string }> = ({ text, colors, backgroundSrc }) => {
    ...
    <AbsoluteFill style={{ backgroundColor: colors.background }}>
      ...
      <AbsoluteFill style={{ justifyContent: "center", alignItems: "center", padding: 60 }}>
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "8px 14px", maxWidth: 900 }}>
          {words.map((word, i) => {
            const s = spring({ frame: frame - i * 3, fps, config: { damping: 12, stiffness: 200 } });
