...
const ENV_VARS: EnvVar[] = [
  ...
  { key: "R2_ACCESS_KEY",         required: false, desc: "Cloudflare R2 access key" },
  { key: "R2_SECRET_KEY",         required: false, desc: "Cloudflare R2 secret key" },
  { key: "R2_BUCKET",             required: false, desc: "Cloudflare R2 bucket name" },
